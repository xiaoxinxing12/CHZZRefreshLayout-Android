...
package org.chzz.refreshlayout.util;
...
import org.chzz.refreshlayout.CHZZStickyNavLayout;
 ...
 * 描述:
 */
public class CHZZRefreshScrollingUtil {

    private CHZZRefreshScrollingUtil() {
    }
    ...
    public static boolean isStickyNavLayoutToTop(CHZZStickyNavLayout stickyNavLayout) {
    ...
    public static boolean isAbsListViewToBottom(AbsListView absListView) {
        if (absListView != null && absListView.getAdapter() != null && absListView.getChildCount() > 0 && absListView.getLastVisiblePosition() == absListView.getAdapter().getCount() - 1) {
            ...
            CHZZStickyNavLayout stickyNavLayout = getStickyNavLayout(absListView);
        ...
        if (recyclerView != null) {
            ...
            if (manager instanceof LinearLayoutManager) {
                ...
                if (layoutManager.findLastCompletelyVisibleItemPosition() == layoutManager.getItemCount() - 1) {
                    CHZZStickyNavLayout stickyNavLayout = getStickyNavLayout(recyclerView);
                    if (stickyNavLayout != null) {
    ...
    public static CHZZStickyNavLayout getStickyNavLayout(View view) {
        ViewParent viewParent = view.getParent();
        while (viewParent != null) {
            if (viewParent instanceof CHZZStickyNavLayout) {
                return (CHZZStickyNavLayout) viewParent;
            }
