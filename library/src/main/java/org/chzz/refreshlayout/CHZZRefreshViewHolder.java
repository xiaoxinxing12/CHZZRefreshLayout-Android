 ...
 * 创建时间:15/5/21 12:56
 * 描述:继承该抽象类实现响应的抽象方法，做出各种下拉刷新效果。参考BGANormalRefreshViewHolder、CHZZStickinessRefreshViewHolder、CHZZMoocStyleRefreshViewHolder、CHZZMeiTuanRefreshViewHolder
 */
public abstract class CHZZRefreshViewHolder {
    /**
     ...
     */
    public CHZZRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
        mContext = context;
