 ...
 * 描述:黏性下拉刷新控件
 */
public class CHZZStickinessRefreshView extends View {
    private static final String TAG = CHZZStickinessRefreshView.class.getSimpleName();
    private CHZZStickinessRefreshViewHolder mStickinessRefreshViewHolder;
    ...
    public CHZZStickinessRefreshView(Context context) {
        this(context, null);
    }

    public CHZZStickinessRefreshView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CHZZStickinessRefreshView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initSize() {
        mEdge = CHZZRefreshLayout.dp2px(getContext(), 5);
        mRotateDrawableSize = CHZZRefreshLayout.dp2px(getContext(), 30);
...
//            mPath.quadTo(mTopBound.left + mTopSize / 8, mTopBound.bottom, mTopBound.left, mTopBound.bottom - mTopSize / 2);
    ...
    public void setStickinessRefreshViewHolder(CHZZStickinessRefreshViewHolder stickinessRefreshViewHolder) {
